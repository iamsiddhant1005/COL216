    ...
    while(j<k+4){
       ...
       if(cycle>=4 &&  j<k+4){
             ...
             if(bubble[p-4]==1){
                ...
                //cout<<dest[j-4]<<endl;
                 ...
                 if(stall[p-4]!=0){cout<<"stall stage4"<<endl;}
                 else cout<<"ins "<< ins_number[p-4]<<" stage4"<<endl;
            }
       }
       // cout<<branch[p-1]<<endl;
       if(cycle>=1 && j<k+1){
               ...
               // cout<<opcode[p-1]<<endl;
                 if(opcode[p-1].compare("beq")==0){
                  ...
                  if(p>=2){
                    ...
                    if(mux_RegDst[p-2]==0){
                       if(ins_number[p-1]!=ins_number[p-2]){
                            ...
                            if(rs[p-1].compare(rd[p-2])==0 || rt[p-1].compare(rd[p-2])==0){
                                ...
                                mux_RegDst[p-1]=0;
                                mux_AluSrc[p-1]=0;
                                instruction[p+1]=instruction[p];
                                
                                instruction[p]=instruction[p-1];
                                ins_number[p+1]=ins_number[p];
                                ins_number[p]=ins_number[p-1];
       ...
       if(cycle>=2 && j<k+2){
            ...
            if(bubble[p-2]==1){
                ...
                read_data1=reg[stoi(rs[p-2])];

                
                if(mux_AluSrc[p-2]==0){
                   read_data2=reg[stoi(rt[p-2])]; 
                 }
               ...
               // cout<<rd[p-2]<<endl;
                ...
                else cout<<"ins "<< ins_number[p-2]<<" stage2"<<endl;
            }    
       }
        //cout<<branch[p-1]<<endl;
       if(cycle>=3 && j<k+3){
          ...
          // cout<<mux_RegWrite[j-3]<<endl;
            
                else cout<<"ins "<< ins_number[p-3] <<" stage3"<<endl;
            }
       }
       //cout<<branch[p-1]<<endl;
